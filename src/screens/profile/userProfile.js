  ...
  return (
    <View>
         ...
         <View style={{display:'flex', alignItems:'center', justifyContent:'center', backgroundColor:"#EEC302", height:400, position:'absolute', width:'100%'}}>
            <Image style={{height:100, width:100, borderRadius:50}} source={{uri: `${user.photo}`}}/>
            <Text style={{fontSize:25, color:'white', fontWeight:'800', marginTop:4}}>{user.fullname}</Text> 
         </View>
